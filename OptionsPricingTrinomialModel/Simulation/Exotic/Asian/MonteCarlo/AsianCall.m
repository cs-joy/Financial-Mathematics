...
% Monte Carlo simulation. T is the time to maturity, Nsteps is the
% number of steps, Nreps is the number of times a path and a price
% is calculated, S0 is the initial stock price, K is the strike price,
